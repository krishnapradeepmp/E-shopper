        ...
        <div class="product-information"><!--/product-information-->
            ...
            <span>
                ...
                <label>Quantity:</label><form name="insert" action="insertToCart.php?id=<?php echo $row['id']; ?>" method="POST">
                    ...
                    <a href="picture_editor/editor.php?image=http://<?php echo getHostByName(getHostName()); ?>/eshopper/images/<?php echo $row['IMAGE']; ?>&id=<?php echo $row['id']; ?>"><input type="button" value="Customize" /></a>
